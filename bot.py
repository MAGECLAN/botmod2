...
class Modmail(commands.Bot):
    ...
    async def on_ready(self):
        ...
        ---------------
        '''))
        await self.change_presence(game=discord.Game(name="DmMeForHelp", status=current_status)	
    ...
    @commands.has_permissions(administrator=True)
    @commands.command(name='changepresence', pass_context=True, aliases=['advstatus'])
